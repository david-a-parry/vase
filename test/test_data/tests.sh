...
vase -i test/test_data/ex1.vcf.gz --cadd_files test/test_data/test_cadd_scores.tsv.gz  --cadd_phred 30  | test/utils/vcf2vars.py > test/test_data/expected_outputs/test_cadd_phred_filters.txt
vase -i test/test_data/ex1.vcf.gz --cadd_files test/test_data/test_cadd_scores.tsv.gz  --cadd_raw 2.25  | test/utils/vcf2vars.py > test/test_data/test_cadd_raw_filters.txt
